...
public class BlockDoor2 extends EasyDoorTileEntityBlock implements ICustomStateMap {
	...
	public void addCollisionBoxToList(IBlockState state, World worldIn, BlockPos pos, AxisAlignedBB entityBox,
		...
		TileEntityDoor2 te = (TileEntityDoor2) worldIn.getTileEntity(pos);
		if (te != null) {
	...
	public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn,
		...
		if (worldIn.getTileEntity(pos) != null && worldIn.getTileEntity(pos) instanceof TileEntityDoor2) {
			if (state.getValue(HALF) == EnumDoorHalf.UPPER) {
				pos = pos.down();
				state = worldIn.getBlockState(pos);
			}

			TileEntityDoor2 door = ((TileEntityDoor2) worldIn.getTileEntity(pos));
			TileEntityDoor2 door2 = ((TileEntityDoor2) worldIn.getTileEntity(pos.up()));
