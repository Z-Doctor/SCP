...
//	}
//
//	static class AIFindTarget extends EntityAINearestAttackableTarget<EntityLivingBase> {
//		private final EntityShyGuy096 shyguy;
//		private EntityLivingBase target;
//
//		public AIFindTarget(EntityShyGuy096 shyguy) {
//			super(shyguy, EntityLivingBase.class, -1, false, false, new Predicate<EntityLivingBase>() {
//				@Override
...
//			boolean flag = this.taskOwner.getAttackTarget() != null && this.taskOwner.getAttackTarget().isEntityAlive()
...
//				if (this.taskOwner.getAttackTarget().getDistanceSqToEntity(this.shyguy) > 256.0D) {
...
//		Vec3d vec3d = new Vec3d(this.posX - target.posX, this.getEntityBoundingBox().minY
//				+ (double) (this.height / 2.0F) - target.posY + (double) target.getEyeHeight(),
...
//		Vec3d vec3d1 = new Vec3d(this.posX - entity.posX, this.getEntityBoundingBox().minY
//				+ (double) this.getEyeHeight() - (entity.posY + (double) entity.getEyeHeight()),
...
//	// final ItemStack itemstack = p_70821_1_.field_71071_by.field_70460_b[3];
...
//	// return d2 > 1.0 - 0.025 / d0 && p_70821_1_.canEntityBeSeen((Entity)this);
//	// }
//
//	@Override
...
//		attackingSpeedBoostModifier = new AttributeModifier(EntityShyGuy096.attackingSpeedBoostModifierUUID,
