...
public class ModelDoorOpen extends ModelBase {
	...
	public ModelDoorOpen(final float par1) {
		...
		(this.Block15 = new ModelRenderer((ModelBase) this, 102, 20)).setTextureSize(128, 128);
		this.Block15.addBox(-7.0f, 11.5f, -1.6f, 3, 2, 1);
		this.Block15.setRotationPoint(-14.0f, 8.000031f, 0.0f);
		(this.Block16 = new ModelRenderer((ModelBase) this, 102, 20)).setTextureSize(128, 128);
		this.Block16.addBox(-3.35f, 11.5f, -1.6f, 3, 2, 1);
		this.Block16.setRotationPoint(-14.0f, 8.000031f, 0.0f);
		(this.Block17 = new ModelRenderer((ModelBase) this, 102, 20)).setTextureSize(128, 128);
		this.Block17.addBox(0.35f, 11.5f, -1.6f, 3, 2, 1);
		this.Block17.setRotationPoint(-14.0f, 8.000031f, 0.0f);
		(this.Block18 = new ModelRenderer((ModelBase) this, 102, 20)).setTextureSize(128, 128);
