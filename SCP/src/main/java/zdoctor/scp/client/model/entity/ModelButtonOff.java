...
public class ModelButtonOff extends ModelBase {
	ModelRenderer Block;
	...
	public ModelButtonOff() {
		this(0.0f);
	}

	public ModelButtonOff(final float par1) {
		...
		this.Block2.addBox(-1.5f, -8.5f, -2.5f, 3, 3, 1);
		...
		this.Block3.setRotationPoint(0.0f, 24.0f, -1.0f);
