...
public class RenderDoor2 extends TileEntitySpecialRenderer {
	private static ResourceLocation TEXTURE = new EntityTextureLocation(ModMain.MODID, "scpdoor2");
	...
	public void render(TileEntity te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
		TileEntityDoor2 door = (TileEntityDoor2) te;
